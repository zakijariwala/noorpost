# Everyone Else — Sumayyah bint Khabbat

**Points home:** *Sumayyah was the first person killed for refusing to give up her faith, and she did not give it up.* · Dateless · Four items

---

## Letter — *The One Who Would Not Say It*
...
| 2 | Person print | **A portrait. Faces allowed in this line.** An older woman standing plainly, upright, hands loose at her sides — composed, not posed as a victim. | Pending |
| 3 | Sticker sheet | A single upright figure motif, a closed fist gently open, small repeatable marks | Pending |
...
**Exterior:** no month cancellation — this line is dateless. Plain seal, name area, *The first, and the word was "no"* printed small.

---

## Notes

**No method is described, per rule L16.** The letter and panel both stay entirely on the fact of sustained pressure and her refusal — no scene of what was done to her, no wound, no final moment. This matches the same restraint the death-line rule applies everywhere else in the product, extended here to the letter itself since this is the one companion whose entire story is built around that pressure.

**This is the first woman added to the companions line since Fizza**, part of closing a real imbalance — seventeen of eighteen companions were men before this batch.

## Open

- [ ] **Verify the Sumayyah bint Khabbat account against a fixed edition** — her status as the first martyr is very widely attested across both Sunni and Shia sources; the specific framing here still needs a citable source before print.
- [ ] Scholar review — sustained-pressure content, confirm the restraint holds on a fresh read
