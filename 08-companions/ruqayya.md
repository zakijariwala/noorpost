# Everyone Else — Sayyida Ruqayya bint al-Husayn

**Points home:** *Ruqayya was younger than Sakina, and she did not survive the captivity that followed Karbala.* · Dateless · Four items
...
**How much room she had:** almost none — the shortest life in this whole line, and still a name kept, on purpose, centuries on.
...
| 2 | Person print | **A portrait. Faces allowed in this line.** A very young girl, seated, still, smaller and younger in bearing than Sakina's portrait — composed, not distressed. | Pending |
| 3 | Sticker sheet | A small lantern, a single flower, small repeatable marks | Pending |
...
**Exterior:** no month cancellation — this line is dateless. Plain seal, name area, *The youngest one is still remembered* printed small.
...
- [ ] **Verify Ruqayya bint al-Husayn's existence, age, and death against a fixed edition — treat with the same scrutiny given to `khawla.md`.**
- [ ] Verify the Damascus shrine's history and the tradition around it
- [ ] Confirm this does not duplicate or crowd `sakina.md` — two entries about young daughters at Karbala need to stay clearly distinct
- [ ] Scholar review — **this is the youngest figure in the entire companions line. Read it with the same particular care given to `sakina.md`, and decide whether the entry survives at all, same as `khawla.md`.**
