# Everyone Else — Umm al-Banin

**Points home:** *Umm al-Banin raised another woman's children as her own, and years later, at Karbala, lost four sons who had grown up doing exactly that.* · Dateless · Five items
...
**How much room she had:** a stepmother's house, with every reason to draw a line between "hers" and "not hers," and she never drew it.
...
**Exterior:** no month cancellation — this line is dateless. Plain seal, name area, *She raised them as her own* printed small.
...
**This letter deliberately does not restage Karbala itself.** No death scene, no battlefield description — the loss is named as a fact that happened, the way envelope 01 and `abbas.md` already hold to rule L16. The letter's centre of gravity is the raising, not the losing.

**She is currently the envelope 01 woman slot on `citation-sheet.md`, still marked "to fill."** This companion entry and that fact-panel row should be checked against the same source once one is found, so the two don't drift into different claims about her.
