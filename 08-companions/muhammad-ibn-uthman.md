# Everyone Else — Muhammad ibn Uthman al-Amri

**Points home:** *Muhammad kept his father's post for about forty years, and never once let the family trade stop being the cover it was.* · Dateless · Four items
...
**How much room he had:** a trade and a trust he had grown up inside, already half-proven before it was ever his alone to carry.

---

## Fact panel — letter reverse

### MUHAMMAD IBN UTHMAN AL-AMRI

● **His trade.** An oil seller, like his father before him — the same market, the same cover, carried on rather than invented fresh.

● **Who he served.** Second of the four trusted agents (*sufara'*) of Imam al-Mahdi, named to the post by his father, Uthman ibn Sa'id, before Uthman died.

● **How long he held it.** About forty years — the longest term of the four, by a wide margin, spanning most of the arrangement's whole seventy-year span.

● **What came after.** Before his own death, he named Husayn ibn Ruh as the third of the four, the same way his father had named him.

● **Why he is in this envelope.** *Muhammad kept his father's post for about forty years, and never once let the family trade stop being the cover it was.*

He died still holding the post, having named his successor himself.
...
| 2 | Person print | **A portrait. Faces allowed in this line.** A man older than Uthman's portrait, same market stall, same jars — visibly the same trade, a generation on. | Pending |
| 3 | Sticker sheet | An oil jar, a scale, a sealed letter, small repeatable marks — deliberately close to Uthman's sheet | Pending |
...
**This is a companion piece to `uthman.md`, deliberately.** Same trade, same cover, same restraint — the point is continuity, a son picking up exactly what his father set down, not a new story. A family holding both should feel the repetition as the point, not as a rerun.

**No occultation theology anywhere in this letter**, per the same rule `uthman.md` and `envelope-10.md` hold to. The letter stays on the working life of a trusted courier — nothing about why the arrangement existed or what it means.

**The forty years is the whole shape of the story**, the way the oil trade itself was the shape of his father's. Longest of the four, and the letter says so plainly rather than leaving it as background detail.

## Open

- [ ] Verify the length of Muhammad ibn Uthman's term against a fixed edition — accounts of the exact span vary
- [ ] Verify how he named Husayn ibn Ruh as his successor
- [ ] Check this letter's claims sit consistently with `uthman.md` and `envelope-10.md` — same names, same order
