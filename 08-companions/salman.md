# Everyone Else — Salman al-Farsi

**Points home:** *Salman served the Prophet.* · Dateless · Five items

---

## Letter — *Three Hundred Trees*
...
**Exterior:** no month cancellation — this line is dateless. Plain seal, name area, *Salman served the Prophet* printed small.

---

## Notes

**The trench is deliberately in the panel and not the letter.** It is the famous thing, and it is a battle, and the letter is better as the story of a man buying himself out one tree at a time. The panel gets the trench in two sentences and a child who wants more has somewhere to go.

**The letter does not resolve his search into a reward.** He arrives enslaved. Being right about something did not unlock the door — the trees did, and other people digging did. That is a truer shape than the one this story is usually given.

## Open

- [ ] Verify the terms of the manumission contract, and the number of trees
- [ ] Verify the governorship and the account of how he lived in it
- [ ] Verify the trench attribution
- [ ] Verify the *Salman is one of us* narration and mark it correctly
- [ ] Scholar review
