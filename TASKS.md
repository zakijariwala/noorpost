...
- [ ] **Close the backlog before writing entry forty.** Print templates exist for 18 of 39; citations verified for 0 of 39; scholar sign-off for 0 of 39; artwork for 0 of 39. See the gaps table in `08-companions/README.md`. Writing entries is the cheap activity and has outrun all four of the expensive ones that gate print.
